	...
	<div class="addEdit-block" :style='{"padding":"30px 5%"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="所在班级" prop="suozaibanji">
					<el-input v-model="ruleForm.suozaibanji" placeholder="所在班级" clearable  :readonly="ro.suozaibanji"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="所在班级" prop="suozaibanji">
					<el-input v-model="ruleForm.suozaibanji" placeholder="所在班级" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="班主任" prop="banzhuren">
					<el-input v-model="ruleForm.banzhuren" placeholder="班主任" clearable  :readonly="ro.banzhuren"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="班主任" prop="banzhuren">
					<el-input v-model="ruleForm.banzhuren" placeholder="班主任" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="宿舍号" prop="sushehao">
					<el-input v-model="ruleForm.sushehao" placeholder="宿舍号" clearable  :readonly="ro.sushehao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="宿舍号" prop="sushehao">
					<el-input v-model="ruleForm.sushehao" placeholder="宿舍号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="入学日期" prop="ruxueriqi">
					<el-date-picker
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.ruxueriqi" label="入学日期" prop="ruxueriqi">
					<el-input v-model="ruleForm.ruxueriqi" placeholder="入学日期" readonly></el-input>
				</el-form-item>
			</template>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='suozaibanji'){
							this.ruleForm.suozaibanji = obj[o];
							this.ro.suozaibanji = true;
							continue;
						}
						if(o=='yuanxi'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `zonghexinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.zonghexinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
