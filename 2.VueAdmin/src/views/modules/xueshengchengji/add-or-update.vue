	...
	<div class="addEdit-block" :style='{"padding":"30px 5%"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="成绩类型" prop="chengjileixing">
					<el-input v-model="ruleForm.chengjileixing" placeholder="成绩类型" clearable  :readonly="ro.chengjileixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="成绩类型" prop="chengjileixing">
					<el-input v-model="ruleForm.chengjileixing" placeholder="成绩类型" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="成绩" prop="chengji">
					<el-input v-model="ruleForm.chengji" placeholder="成绩" clearable  :readonly="ro.chengji"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="成绩" prop="chengji">
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='chengjileixing'){
							this.ruleForm.chengjileixing = obj[o];
							this.ro.chengjileixing = true;
							continue;
						}
						if(o=='chengji'){
